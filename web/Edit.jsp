                        ...
                        <form action="edit" method="post">
                            ...
                            <div class="modal-body">					
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                <label>CatID</label>
                                <input value="${detail.catID}" name="catID" type="number" class="form-control" required>
                            </div>
                                <div class="form-group">
                                <label>Category</label>
                              <input value="${detail.category}" name="Category" type="text" class="form-control" required>
                            </div>
